...
```
# Output:
<img width="557" height="261" alt="image" src="https://github.com/user-attachments/assets/f88de13b-e426-4fff-8739-906e6080036d" />
...
```
# Output:
<img width="611" height="433" alt="image" src="https://github.com/user-attachments/assets/6aaff4fa-9855-4cb8-84f4-0cbbf7b3d1d7" />
...
```
# Output:
<img width="570" height="243" alt="image" src="https://github.com/user-attachments/assets/6b3d7c05-8ba1-4367-b58f-7e67afddf998" />
...
```
# Output:
<img width="552" height="472" alt="image" src="https://github.com/user-attachments/assets/ad1ad316-1ff8-4305-a0cd-1d6fd02f0ed8" />
...
```
# Output:
<img width="732" height="242" alt="image" src="https://github.com/user-attachments/assets/35f96f32-fd37-4920-b436-1491bdd5c032" />
